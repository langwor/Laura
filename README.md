...
> [![Deploy](https://www.herokucdn.com/deploy/button.png)](https://dashboard.heroku.com/new?template=https://github.com/langwor/Laura)
...
| 变量 | 默认值 | 说明 |
| :--- | :--- | :--- |
| `ID` | `ff783c47-1e15-42c2-9edd-cdc7038049c4` | VMess 用户主 ID，用于身份验证，为 UUID 格式 |
